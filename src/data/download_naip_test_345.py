"""
download_naip_test_345.py
Downloads NAIP tiles for NY 345kV new test corridors.
"""
import requests
...
CORRIDORS_SHP = Path("data/collected/345_test_set.shp")
...
print("Loading 345kV test corridor polygons...")
...
print(f"Searching for NAIP {NAIP_YEAR} tiles (NY)...")
